...
--
-- Host: localhost
-- Generation Time: Nov 10, 2014 at 06:04 AM
...
(1000, 10001, 1111, 'saving', 'Akshay Mahadik', 40678, '2018-03-31'),
...
CREATE TABLE IF NOT EXISTS `electricitybill` (
  `etrid` int(10) NOT NULL AUTO_INCREMENT,
  `atmno` int(20) NOT NULL,
  `accno` int(20) NOT NULL,
  `ebillno` int(30) NOT NULL,
  `ebillamount` float NOT NULL,
  `edate` date NOT NULL,
  PRIMARY KEY (`etrid`)
...
INSERT INTO `electricitybill` (`etrid`, `atmno`, `accno`, `ebillno`, `ebillamount`, `edate`) VALUES
(13, 1000, 10001, 100, 500, '2014-11-07'),
(14, 1000, 10001, 111, 100, '2014-11-08'),
(15, 1000, 10001, 150, 500, '2014-11-08');
...
CREATE TABLE IF NOT EXISTS `transaction` (
  ...
  `atmno` int(20) NOT NULL,
  `accno` int(20) NOT NULL,
  `depositamt` float NOT NULL COMMENT 'deposit amount',
  `withamt` float NOT NULL,
...
(116, 1000, 10001, 0, 200, 66700, '2014-11-07'),
(117, 1000, 10001, 0, 100, 66600, '2014-11-07'),
(118, 1000, 10001, 1000, 0, 67600, '2014-11-07'),
(119, 1000, 10001, 0, 500, 67100, '2014-11-07'),
(120, 1000, 10001, 0, 2222, 64878, '2014-11-07'),
(121, 1000, 10001, 0, 5000, 59878, '2014-11-07'),
(122, 1000, 10001, 0, 5000, 54878, '2014-11-07'),
(123, 1000, 10001, 0, 5000, 49878, '2014-11-07'),
(124, 1000, 10001, 0, 5000, 44878, '2014-11-07'),
(125, 1000, 10001, 0, 200, 44678, '2014-11-08'),
(126, 1000, 10001, 0, 300, 44378, '2014-11-08'),
(127, 1000, 10001, 0, 300, 44078, '2014-11-08'),
(128, 1000, 10001, 0, 800, 43278, '2014-11-08'),
(129, 1000, 10001, 0, 500, 42778, '2014-11-08'),
(130, 1000, 10001, 0, 700, 42078, '2014-11-08'),
(131, 1000, 10001, 0, 500, 41578, '2014-11-08'),
(132, 1000, 10001, 0, 100, 41278, '2014-11-08'),
(133, 1000, 10001, 0, 100, 41178, '2014-11-08'),
(134, 1000, 10001, 0, 500, 40678, '2014-11-08');
